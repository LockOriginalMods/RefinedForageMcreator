...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(RefinedForageLibs.MOD_ID, "textures/gui/spawner_gui.png");


    public SpawnerScreen() {
        super(new TranslationTextComponent("screen.refinedforagelibs.spawn"));
    }
