...
import com.LockOriginalMods.refinedforagelibs.CustomEnergyStorage;
...
import static com.LockOriginalMods.refinedforagelibs.Registration.COAL_GENERATOR_TILE;
...
public class CoalGeneratorTile extends TileEntity implements ITickableTileEntity {
    ...
    public void tick() {
        ...
        if (counter <= 0) {
            ...
            if (stack.getItem() == Items.CHARCOAL || stack.getItem() == Items.COAL || stack.getItem() == Items.COAL_BLOCK) {
    ...
    private ItemStackHandler createHandler() {
        return new ItemStackHandler(1) {
            ...
            public boolean isItemValid(int slot, @Nonnull ItemStack stack)
                {
                    return stack.getItem() == Items.CHARCOAL || stack.getItem() == Items.COAL || stack.getItem() == Items.COAL_BLOCK;
                }
