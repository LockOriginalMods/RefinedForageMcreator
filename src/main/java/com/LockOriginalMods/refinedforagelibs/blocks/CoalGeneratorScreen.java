...
import com.LockOriginalMods.refinedforagelibs.RefinedForageLibs;
...
public class CoalGeneratorScreen extends ContainerScreen<CoalGeneratorContainer> {
    ...
    private ResourceLocation GUI = new ResourceLocation(RefinedForageLibs.MOD_ID, "textures/gui/coal_generator_gui.png");
